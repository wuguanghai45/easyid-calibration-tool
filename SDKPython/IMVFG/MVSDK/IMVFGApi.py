...
class Capture():
    ...
    def IMV_FG_OpenInterfaceEx(self,mode,pIdentifier):
        MVSDKdll.IMV_FG_OpenInterfaceEx.argtype=(c_uint,c_void_p,c_void_p)
        MVSDKdll.IMV_FG_OpenInterfaceEx.argtype=(c_uint,c_void_p,c_void_p)
        MVSDKdll.IMV_FG_OpenInterfaceEx.restype=c_int
    ...
    def IMV_FG_DownLoadGenICamXML(self,pFullFileName):
        ...
        return MVSDKdll.IMV_FG_DownLoadGenICamXML(self.handle,pFullFileName.encode('utf-8'))
    ...
    def IMV_FG_SaveDeviceCfg(self,pFullFileName):
        ...
        return MVSDKdll.IMV_FG_SaveDeviceCfg(self.handle,pFullFileName.encode('utf-8'))
    ...
    def IMV_FG_LoadDeviceCfg(self,pFullFileName,pErrorList):
        ...
        return MVSDKdll.IMV_FG_LoadDeviceCfg(self.handle,pFullFileName.encode('utf-8'),byref(pErrorList))
    ...
    def IMV_FG_FeatureIsAvailable(self,pFeatureName):
        ...
        return MVSDKdll.IMV_FG_FeatureIsAvailable(self.handle,pFeatureName.encode('utf-8'))
    ...
    def IMV_FG_FeatureIsReadable(self,pFeatureName):
        ...
        return MVSDKdll.IMV_FG_FeatureIsReadable(self.handle,pFeatureName.encode('utf-8'))
    ...
    def IMV_FG_FeatureIsWriteable(self,pFeatureName):
        ...
        return MVSDKdll.IMV_FG_FeatureIsWriteable(self.handle,pFeatureName.encode('utf-8'))
    ...
    def IMV_FG_FeatureIsStreamable(self,pFeatureName):
        ...
        return MVSDKdll.IMV_FG_FeatureIsStreamable(self.handle,pFeatureName.encode('utf-8'))
    ...
    def IMV_FG_FeatureIsValid(self,pFeatureName):
        ...
        return MVSDKdll.IMV_FG_FeatureIsValid(self.handle,pFeatureName.encode('utf-8'))
    ...
    def IMV_FG_GetFeatureType(self,pFeatureName,pPropertyType):
        ...
        return MVSDKdll.IMV_FG_GetFeatureType(self.handle,pFeatureName.encode('utf-8'),byref(pPropertyType))
    ...
    def IMV_FG_GetIntFeatureValue(self,pFeatureName,pIntValue):
        ...
        return MVSDKdll.IMV_FG_GetIntFeatureValue(self.handle,pFeatureName.encode('utf-8'),byref(pIntValue))
    ...
    def IMV_FG_GetIntFeatureMin(self,pFeatureName,pIntValue):
        ...
        return MVSDKdll.IMV_FG_GetIntFeatureMin(self.handle,pFeatureName.encode('utf-8'),byref(pIntValue))
    ...
    def IMV_FG_GetIntFeatureMax(self,pFeatureName,pIntValue):
        ...
        return MVSDKdll.IMV_FG_GetIntFeatureMax(self.handle,pFeatureName.encode('utf-8'),byref(pIntValue))
    ...
    def IMV_FG_GetIntFeatureInc(self,pFeatureName,pIntValue):
        ...
        return MVSDKdll.IMV_FG_GetIntFeatureInc(self.handle,pFeatureName.encode('utf-8'),byref(pIntValue))
    ...
    def IMV_FG_SetIntFeatureValue(self,pFeatureName,pIntValue):
        ...
        return MVSDKdll.IMV_FG_SetIntFeatureValue(self.handle,pFeatureName.encode('utf-8'),c_int64(pIntValue))
    ...
    def IMV_FG_GetDoubleFeatureValue(self,pFeatureName,pDoubleValue):
        ...
        return MVSDKdll.IMV_FG_GetDoubleFeatureValue(self.handle,pFeatureName.encode('utf-8'),byref(pDoubleValue))
    ...
    def IMV_FG_GetDoubleFeatureMin(self,pFeatureName,pDoubleValue):
        ...
        return MVSDKdll.IMV_FG_GetDoubleFeatureMin(self.handle,pFeatureName.encode('utf-8'),byref(pDoubleValue))
    ...
    def IMV_FG_GetDoubleFeatureMax(self,pFeatureName,pDoubleValue):
        ...
        return MVSDKdll.IMV_FG_GetDoubleFeatureMax(self.handle,pFeatureName.encode('utf-8'),byref(pDoubleValue))
    ...
    def IMV_FG_SetDoubleFeatureValue(self,pFeatureName,doubleValue):
        ...
        return MVSDKdll.IMV_FG_SetDoubleFeatureValue(self.handle,pFeatureName.encode('utf-8'),c_double(doubleValue))
    ...
    def IMV_FG_GetBoolFeatureValue(self,pFeatureName,pBoolValue):
        ...
        return MVSDKdll.IMV_FG_GetBoolFeatureValue(self.handle,pFeatureName.encode('utf-8'),byref(pBoolValue))
    ...
    def IMV_FG_SetBoolFeatureValue(self,pFeatureName,boolValue):
        ...
        return MVSDKdll.IMV_FG_SetBoolFeatureValue(self.handle,pFeatureName.encode('utf-8'),c_bool(boolValue))
    ...
    def IMV_FG_GetEnumFeatureValue(self,pFeatureName,pEnumValue):
        ...
        return MVSDKdll.IMV_FG_GetEnumFeatureValue(self.handle,pFeatureName.encode('utf-8'),byref(pEnumValue))
    ...
    def IMV_FG_SetEnumFeatureValue(self,pFeatureName,enumValue):
        ...
        return MVSDKdll.IMV_FG_SetEnumFeatureValue(self.handle,pFeatureName.encode('utf-8'),enumValue)
    ...
    def IMV_FG_GetEnumFeatureSymbol(self,pFeatureName,pEnumSymbol):
        ...
        return MVSDKdll.IMV_FG_GetEnumFeatureSymbol(self.handle,pFeatureName.encode('utf-8'),byref(pEnumSymbol))
    ...
    def IMV_FG_SetEnumFeatureSymbol(self,pFeatureName,pEnumSymbol):
        ...
        return MVSDKdll.IMV_FG_SetEnumFeatureSymbol(self.handle,pFeatureName.encode('utf-8'),pEnumSymbol.encode('utf-8'))
    ...
    def IMV_FG_GetEnumFeatureEntryNum(self,pFeatureName,pEntryNum):
        ...
        return MVSDKdll.IMV_FG_GetEnumFeatureEntryNum(self.handle,pFeatureName.encode('utf-8'),byref(pEntryNum))
    ...
    def IMV_FG_GetEnumFeatureEntrys(self,pFeatureName,pEnumEntryList):
        ...
        return MVSDKdll.IMV_FG_GetEnumFeatureEntrys(self.handle,pFeatureName.encode('utf-8'),byref(pEnumEntryList))
    ...
    def IMV_FG_GetStringFeatureValue(self,pFeatureName,pStringValue):
        ...
        return MVSDKdll.IMV_FG_GetStringFeatureValue(self.handle,pFeatureName.encode('utf-8'),byref(pStringValue))
    ...
    def IMV_FG_SetStringFeatureValue(self,pFeatureName,pStringValue):
        ...
        return MVSDKdll.IMV_FG_SetStringFeatureValue(self.handle,pFeatureName.encode('utf-8'),pStringValue.encode('utf-8'))
    ...
    def IMV_FG_ExecuteCommandFeature(self,pFeatureName):
        ...
        return MVSDKdll.IMV_FG_ExecuteCommandFeature(self.handle,pFeatureName.encode('utf-8'))
