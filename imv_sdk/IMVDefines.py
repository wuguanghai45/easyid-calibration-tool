...
# ch:gige接口信息 | en:Gige interface information
...
# ch:usb接口信息 | en:USB interface information
...
# ch:GigE设备信息 | en:english GigE device info
...
# ch:USB设备信息 | en:english USB device info
...
class _IMV_SaveImageParam_(Structure):
    pass
_IMV_SaveImageParam_._fields_ = [
    ('nWidth', c_uint),
    ('nHeight', c_uint),
    ('ePixelFormat', c_int),
    ('pSrcData', POINTER(c_ubyte)),
...
IMV_SaveImageParam = _IMV_SaveImageParam_